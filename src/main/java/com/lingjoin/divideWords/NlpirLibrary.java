...
public class NlpirLibrary {
	...
	public interface CLibraryNlpir extends Library {
        ...
        //CLibraryNlpir Instance = (CLibraryNlpir) Native.loadLibrary("NLPIR", CLibraryNlpir.class);
        CLibraryNlpir Instance = (CLibraryNlpir) Native.loadLibrary("ext_module/"+SystemConfig.NLPIRModuleName(), CLibraryNlpir.class);
